        ...
        <section className="relative flex md:min-h-[70vh] flex-col items-center justify-center bg-background px-4 sm:px-6 md:px-12 lg:px-24 py-16 sm:py-24 text-center">
            ...
            <div className="w-full max-w-3xl">
                ...
                <div className="mt-8 sm:mt-10 relative max-w-2xl mx-auto">
                    ...
                    {/* Etiquetas rápidas debajo del buscador */}
                    <div className="mt-3 sm:mt-4 flex flex-wrap justify-center gap-1 sm:gap-2">
                        ...
                        <button className="text-xs sm:text-sm font-medium hover:text-primary underline-offset-4 hover:underline">Electrónica</button>
                        <button className="text-xs sm:text-sm font-medium hover:text-primary underline-offset-4 hover:underline">Hogar</button>
                        <button className="text-xs sm:text-sm font-medium hover:text-primary underline-offset-4 hover:underline">Accesorios</button>
                    </div>
                </div>
